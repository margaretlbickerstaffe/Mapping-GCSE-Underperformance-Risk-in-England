...
cross_sectional_20162017 <- read.csv("msoaAgg20162017.csv", row.names = NULL, check.names = FALSE)

# drop any row with an NA anywhere
cross_sectional_20162017 <- cross_sectional_20162017 %>% drop_na()
# check length
nrow(cross_sectional_20162017)

# convert rates to decimals
names(cross_sectional_20162017)
cross_sectional_20162017$TotalAchievers <- round(cross_sectional_20162017$TotalAchievers)
cross_sectional_20162017$RateofStudentAchievers <- cross_sectional_20162017$MSOA_GCSE_Mean / 100
cross_sectional_20162017$RateOFFemaleStudents <- cross_sectional_20162017$PercentFemale / 100
cross_sectional_20162017$RateOfStudentReceivingFreeSchoolMeals <- cross_sectional_20162017$PercentOfStudentReceivingFreeSchoolMeals / 100
cross_sectional_20162017$FSMRate <- cross_sectional_20162017$RateOfStudentReceivingFreeSchoolMeals
cross_sectional_20162017$BlackPopulationRate <- cross_sectional_20162017$BlackPopulationRate/100
cross_sectional_20162017$AsianPopulationRate <- cross_sectional_20162017$AsianPopulationRate/100
cross_sectional_20162017$WhitePopulationRate <- cross_sectional_20162017$WhitePopulationRate/100
cross_sectional_20162017$OtherRacePopulationRate <- cross_sectional_20162017$OtherRacePopulationRate/100
cross_sectional_20162017$YPAccessibilityDecile <- cross_sectional_20162017$BordaAccessibilityDecile
cross_sectional_20162017$RateOfStudentUnderAchievers <- (cross_sectional_20162017$TotalPupils_GCSE - cross_sectional_20162017$TotalAchievers) / cross_sectional_20162017$TotalPupils_GCSE

# drop schools that are all female or all male
cross_sectional_20162017 <- cross_sectional_20162017[cross_sectional_20162017$RateOFFemaleStudents > 0.05 & cross_sectional_20162017$RateOFFemaleStudents < 0.95, ]

# drop reference columns not needed for Urbanization and Race
cross_sectional_20162017 <- cross_sectional_20162017[, !names(cross_sectional_20162017) %in% c("LargeCentralMetro", "WhitePopulationRate")]

# remove duplicate MSOA (by MSOA (code))
cross_sectional_20162017 <- cross_sectional_20162017[!duplicated(cross_sectional_20162017$`MSOA (code)`), ]
# check length
nrow(cross_sectional_20162017)

########################## DATA CLEANSING AND WRANGLING  ###############################
# load in the informational data for spatial distribtion maps
spatialDistributionMaps <- read.csv("msoaAgg20162017.csv")
# drop nas again 
...
cross_sectional_20162017$Grade5Underperformance <- cross_sectional_20162017$TotalPupils_GCSE - cross_sectional_20162017$TotalAchievers
cross_sectional_20162017$Expected <- expected(
  population = cross_sectional_20162017$TotalPupils_GCSE,
  cases = cross_sectional_20162017$Grade5Underperformance,
  n.strata = 1
)

# round Expected to a whole number 
cross_sectional_20162017$Expected <- round(cross_sectional_20162017$Expected, .1)
...
analysis_cross_data <- merge(englandMSOA, cross_sectional_20162017, 
                             by.x = c("MSOA21CD"),
                             by.y = c("MSOA (code)"))
...
sdYPDecile <- tm_shape(spatialDistributionMaps) +
...
################################# CORRELATION MATRIX #######################################
cor_matrix <- cor(cross_sectional_20162017[, c("BordaAccessibilityDecile", "FSMRate", "IDACI", "SAMHI", "RateOFFemaleStudents",
...
cross_sectional_20162017 <- cross_sectional_20162017[, !names(cross_sectional_20162017) %in% c("IDACI")]
...
sdRelativeRisk
tmap_save(sdRelativeRisk, filename = "/Users/maggiebickerstaffe/Desktop/Dissertation/WalkableCharities/BayesianRisks/RelativeRisk/england20162017", width = 2400, height = 2400, dpi = 300)
...
map_manchester
tmap_save(map_manchester, filename = "/Users/maggiebickerstaffe/Desktop/Dissertation/WalkableCharities/BayesianRisks/RelativeRisk/manchester20162017", width = 2400, height = 2400, dpi = 300)

map_london
tmap_save(map_london, filename = "/Users/maggiebickerstaffe/Desktop/Dissertation/WalkableCharities/BayesianRisks/RelativeRisk/london20162017", width = 2400, height = 2400, dpi = 300)
...
map_B
tmap_save(map_B, filename = "/Users/maggiebickerstaffe/Desktop/Dissertation/WalkableCharities/BayesianRisks/Significance/england20162017", width = 2400, height = 2400, dpi = 300)
...
map_B_manchester
tmap_save(map_B_manchester, filename = "/Users/maggiebickerstaffe/Desktop/Dissertation/WalkableCharities/BayesianRisks/Significance/manchester20162017", width = 2400, height = 2400, dpi = 300)
map_B_london
tmap_save(map_B_london, filename = "/Users/maggiebickerstaffe/Desktop/Dissertation/WalkableCharities/BayesianRisks/Significance/london20162017", width = 2400, height = 2400, dpi = 300)
...
map_C
tmap_save(map_C, filename = "/Users/maggiebickerstaffe/Desktop/Dissertation/WalkableCharities/BayesianRisks/ExceedanceProbability/england20162017", width = 2400, height = 2400, dpi = 300)
...
map_C_manchester
tmap_save(map_C_manchester, filename = "/Users/maggiebickerstaffe/Desktop/Dissertation/WalkableCharities/BayesianRisks/ExceedanceProbability/manchester20162017", width = 2400, height = 2400, dpi = 300)
map_C_london
tmap_save(map_C_london, filename = "/Users/maggiebickerstaffe/Desktop/Dissertation/WalkableCharities/BayesianRisks/ExceedanceProbability/london20162017", width = 2400, height = 2400, dpi = 300)
...
# write to csv
write.csv(export_df, "relative_risk_results_20162017.csv", row.names = FALSE)

################################# SAVE RDS #######################################
saveRDS(results_cross_sectional, "results_cross_sectional_2016_2017.rds")
...
fixed_only <- inla(Grade5Underperformance ~ YPAccessibilityDecile + FSMRate + PercentFemale +
                     SAMHI + LargeFringeMetro + MediumMetro + SmallMetro + Micropolitan + Noncore,
                   family = "poisson", E = cross_sectional_20162017$Expected, data = cross_sectional_20162017,
                   control.compute = list(dic = TRUE, waic = TRUE))

fitted_fixed <- fixed_only$summary.fitted.values[, "mean"] * cross_sectional_20162017$Expected
cor(cross_sectional_20162017$Grade5Underperformance, fitted_fixed)^2
