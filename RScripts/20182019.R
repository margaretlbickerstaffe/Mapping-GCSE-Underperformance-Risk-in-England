...
cross_sectional_20182019 <- read.csv("msoaAgg20182019.csv", row.names = NULL, check.names = FALSE)

# drop any row with an NA anywhere
cross_sectional_20182019 <- cross_sectional_20182019 %>% drop_na()
# check length
nrow(cross_sectional_20182019)

# convert rates to decimals
names(cross_sectional_20182019)
cross_sectional_20182019$TotalAchievers <- round(cross_sectional_20182019$TotalAchievers)
cross_sectional_20182019$RateofStudentAchievers <- cross_sectional_20182019$MSOA_GCSE_Mean / 100
cross_sectional_20182019$RateOFFemaleStudents <- cross_sectional_20182019$PercentFemale / 100
cross_sectional_20182019$RateOfStudentReceivingFreeSchoolMeals <- cross_sectional_20182019$PercentOfStudentReceivingFreeSchoolMeals / 100
cross_sectional_20182019$FSMRate <- cross_sectional_20182019$RateOfStudentReceivingFreeSchoolMeals
cross_sectional_20182019$BlackPopulationRate <- cross_sectional_20182019$BlackPopulationRate/100
cross_sectional_20182019$AsianPopulationRate <- cross_sectional_20182019$AsianPopulationRate/100
cross_sectional_20182019$WhitePopulationRate <- cross_sectional_20182019$WhitePopulationRate/100
cross_sectional_20182019$OtherRacePopulationRate <- cross_sectional_20182019$OtherRacePopulationRate/100
cross_sectional_20182019$YPAccessibilityDecile <- cross_sectional_20182019$BordaAccessibilityDecile
cross_sectional_20182019$RateOfStudentUnderAchievers <- (cross_sectional_20182019$TotalPupils_GCSE - cross_sectional_20182019$TotalAchievers) / cross_sectional_20182019$TotalPupils_GCSE

# drop schools that are all female or all male
cross_sectional_20182019 <- cross_sectional_20182019[cross_sectional_20182019$RateOFFemaleStudents > 0.05 & cross_sectional_20182019$RateOFFemaleStudents < 0.95, ]

# drop reference columns not needed for Urbanization and Race
cross_sectional_20182019 <- cross_sectional_20182019[, !names(cross_sectional_20182019) %in% c("LargeCentralMetro", "WhitePopulationRate")]

# remove duplicate MSOA (by MSOA (code))
cross_sectional_20182019 <- cross_sectional_20182019[!duplicated(cross_sectional_20182019$`MSOA (code)`), ]
# check length
nrow(cross_sectional_20182019)

########################## DATA CLEANSING AND WRANGLING  ###############################
# load in the informational data for spatial distribtion maps
spatialDistributionMaps <- read.csv("msoaAgg20182019.csv")
# drop nas again 
...
cross_sectional_20182019$Grade5Underperformance <- cross_sectional_20182019$TotalPupils_GCSE - cross_sectional_20182019$TotalAchievers
cross_sectional_20182019$Expected <- expected(
  population = cross_sectional_20182019$TotalPupils_GCSE,
  cases = cross_sectional_20182019$Grade5Underperformance,
  n.strata = 1
)

# round Expected to a whole number 
cross_sectional_20182019$Expected <- round(cross_sectional_20182019$Expected, .1)
...
analysis_cross_data <- merge(englandMSOA, cross_sectional_20182019, 
                             by.x = c("MSOA21CD"),
                             by.y = c("MSOA (code)"))
...
################################# CORRELATION MATRIX #######################################
cor_matrix <- cor(cross_sectional_20182019[, c("BordaAccessibilityDecile", "FSMRate", "IDACI", "SAMHI", "RateOFFemaleStudents",
...
cross_sectional_20182019 <- cross_sectional_20182019[, !names(cross_sectional_20182019) %in% c("IDACI")]
...
sdRelativeRisk
tmap_save(sdRelativeRisk, filename = "/Users/maggiebickerstaffe/Desktop/Dissertation/WalkableCharities/BayesianRisks/RelativeRisk/england20182019.png", width = 2400, height = 2400, dpi = 300)
...
map_manchester
tmap_save(map_manchester, filename = "/Users/maggiebickerstaffe/Desktop/Dissertation/WalkableCharities/BayesianRisks/RelativeRisk/manchester20182019.png", width = 2400, height = 2400, dpi = 300)

map_london
tmap_save(map_london, filename = "/Users/maggiebickerstaffe/Desktop/Dissertation/WalkableCharities/BayesianRisks/RelativeRisk/london20182019.png", width = 2400, height = 2400, dpi = 300)
...
map_B
tmap_save(map_B, filename = "/Users/maggiebickerstaffe/Desktop/Dissertation/WalkableCharities/BayesianRisks/Significance/england20182019.png", width = 2400, height = 2400, dpi = 300)
...
map_B_manchester
tmap_save(map_B_manchester, filename = "/Users/maggiebickerstaffe/Desktop/Dissertation/WalkableCharities/BayesianRisks/Significance/manchester20182019.png", width = 2400, height = 2400, dpi = 300)
map_B_london
tmap_save(map_B_london, filename = "/Users/maggiebickerstaffe/Desktop/Dissertation/WalkableCharities/BayesianRisks/Significance/london20182019.png", width = 2400, height = 2400, dpi = 300)
...
map_C
tmap_save(map_C, filename = "/Users/maggiebickerstaffe/Desktop/Dissertation/WalkableCharities/BayesianRisks/ExceedanceProbability/england20182019.png", width = 2400, height = 2400, dpi = 300)
...
map_C_manchester
tmap_save(map_C_manchester, filename = "/Users/maggiebickerstaffe/Desktop/Dissertation/WalkableCharities/BayesianRisks/ExceedanceProbability/manchester20182019.png", width = 2400, height = 2400, dpi = 300)
map_C_london
tmap_save(map_C_london, filename = "/Users/maggiebickerstaffe/Desktop/Dissertation/WalkableCharities/BayesianRisks/ExceedanceProbability/london20182019.png", width = 2400, height = 2400, dpi = 300)
...
# write to csv
write.csv(export_df, "relative_risk_results_20182019.csv", row.names = FALSE)

################################# SAVE RDS #######################################
saveRDS(results_cross_sectional, "results_cross_sectional_2018_2019.rds")
...
fixed_only <- inla(Grade5Underperformance ~ YPAccessibilityDecile + FSMRate + PercentFemale +
                     SAMHI + LargeFringeMetro + MediumMetro + SmallMetro + Micropolitan + Noncore,
                   family = "poisson", E = cross_sectional_20182019$Expected, data = cross_sectional_20182019,
                   control.compute = list(dic = TRUE, waic = TRUE))

fitted_fixed <- fixed_only$summary.fitted.values[, "mean"] * cross_sectional_20182019$Expected
cor(cross_sectional_20182019$Grade5Underperformance, fitted_fixed)^2
