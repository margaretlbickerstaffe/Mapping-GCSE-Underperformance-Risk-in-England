...
cross_sectional_20242025 <- read.csv("msoaAgg20242025.csv", row.names = NULL, check.names = FALSE)

# drop any row with an NA anywhere
cross_sectional_20242025 <- cross_sectional_20242025 %>% drop_na()
# check length
nrow(cross_sectional_20242025)

# convert rates to decimals
names(cross_sectional_20242025)
cross_sectional_20242025$TotalAchievers <- round(cross_sectional_20242025$TotalAchievers)
cross_sectional_20242025$RateofStudentAchievers <- cross_sectional_20242025$MSOA_GCSE_Mean / 100
cross_sectional_20242025$RateOFFemaleStudents <- cross_sectional_20242025$PercentFemale / 100
cross_sectional_20242025$RateOfStudentReceivingFreeSchoolMeals <- cross_sectional_20242025$PercentOfStudentReceivingFreeSchoolMeals / 100
cross_sectional_20242025$FSMRate <- cross_sectional_20242025$RateOfStudentReceivingFreeSchoolMeals
cross_sectional_20242025$BlackPopulationRate <- cross_sectional_20242025$BlackPopulationRate/100
cross_sectional_20242025$AsianPopulationRate <- cross_sectional_20242025$AsianPopulationRate/100
cross_sectional_20242025$WhitePopulationRate <- cross_sectional_20242025$WhitePopulationRate/100
cross_sectional_20242025$OtherRacePopulationRate <- cross_sectional_20242025$OtherRacePopulationRate/100
cross_sectional_20242025$YPAccessibilityDecile <- cross_sectional_20242025$BordaAccessibilityDecile
cross_sectional_20242025$RateOfStudentUnderAchievers <- (cross_sectional_20242025$TotalPupils_GCSE - cross_sectional_20242025$TotalAchievers) / cross_sectional_20242025$TotalPupils_GCSE

# drop schools that are all female or all male
cross_sectional_20242025 <- cross_sectional_20242025[cross_sectional_20242025$RateOFFemaleStudents > 0.05 & cross_sectional_20242025$RateOFFemaleStudents < 0.95, ]

# drop reference columns not needed for Urbanization and Race
cross_sectional_20242025 <- cross_sectional_20242025[, !names(cross_sectional_20242025) %in% c("LargeCentralMetro", "WhitePopulationRate")]

# remove duplicate MSOA (by MSOA (code))
cross_sectional_20242025 <- cross_sectional_20242025[!duplicated(cross_sectional_20242025$`MSOA (code)`), ]
# check length
nrow(cross_sectional_20242025)

########################## DATA CLEANSING AND WRANGLING  ###############################
# load in the informational data for spatial distribtion maps
spatialDistributionMaps <- read.csv("msoaAgg20242025.csv")
# drop nas again 
...
cross_sectional_20242025$Grade5Underperformance <- cross_sectional_20242025$TotalPupils_GCSE - cross_sectional_20242025$TotalAchievers
cross_sectional_20242025$Expected <- expected(
  population = cross_sectional_20242025$TotalPupils_GCSE,
  cases = cross_sectional_20242025$Grade5Underperformance,
  n.strata = 1
)

# round Expected to a whole number 
cross_sectional_20242025$Expected <- round(cross_sectional_20242025$Expected, .1)
...
analysis_cross_data <- merge(englandMSOA, cross_sectional_20242025, 
                             by.x = c("MSOA21CD"),
                             by.y = c("MSOA (code)"))
...
################################# YP MAP ##############################################
# spatial distribution of YP Accessibility Decile
sdYPDecile <- tm_shape(englandOutline) +
  tm_polygons(fill = "grey95", col = "grey70", lwd = 0.3) +
  tm_shape(spatialDistributionMaps) +
  tm_polygons(fill = "grey85", col = "grey60", lwd = 0.01) +
  tm_shape(analysis_cross_data) +
  tm_polygons(
    fill = "BordaAccessibilityDecile",
    col  = "grey60",
    lwd  = .1,
    fill.scale = tm_scale_intervals(
      n = 10,
      style = "pretty",
      values = rev(brewer.pal(10, "RdYlGn"))
    ),
    fill.legend = tm_legend(title = "Youth Provision\nAccessibility Decile", frame = FALSE)
  ) +
...
sdYPDecile
tmap_save(sdYPDecile, filename = "/Users/maggiebickerstaffe/Desktop/Dissertation/WalkableCharities/BayesianRisks/sdYPDecile.png", width = 2400, height = 2400, dpi = 300)
...
# london
map_london_yp <- tm_shape(london) +
  tm_polygons(fill = "grey85", col = "grey60", lwd = 0.1) +
  tm_shape(london_rr) +
  tm_polygons(
    fill = "BordaAccessibilityDecile",
    col  = "grey60", lwd = .1,
    fill.scale = tm_scale_intervals(n = 10, style = "pretty", values = rev(brewer.pal(10, "RdYlGn"))),
    fill.legend = tm_legend_hide()
  ) +
  tm_scalebar(position = c("right", "bottom"), text.size = 0.5) +
  tm_layout(frame = TRUE, bg.color = "white")
map_london_yp
tmap_save(map_london_yp, filename = "/Users/maggiebickerstaffe/Desktop/Dissertation/WalkableCharities/BayesianRisks/map_london_yp.png", width = 2400, height = 2400, dpi = 300)

# manchester
map_manchester_yp <- tm_shape(manchester) +
  tm_polygons(fill = "grey85", col = "grey60", lwd = 0.1) +
  ...
  tm_layout(frame = TRUE, bg.color = "white")
map_manchester_yp
tmap_save(map_manchester_yp, filename = "/Users/maggiebickerstaffe/Desktop/Dissertation/WalkableCharities/BayesianRisks/map_manchester_yp.png", width = 2400, height = 2400, dpi = 300)
...
################################# CORRELATION MATRIX #######################################
cor_matrix <- cor(cross_sectional_20242025[, c("BordaAccessibilityDecile", "FSMRate", "IDACI", "SAMHI", "RateOFFemaleStudents",
...
cross_sectional_20242025 <- cross_sectional_20242025[, !names(cross_sectional_20242025) %in% c("IDACI")]
...
sdRelativeRisk
tmap_save(sdRelativeRisk, filename = "/Users/maggiebickerstaffe/Desktop/Dissertation/WalkableCharities/BayesianRisks/RelativeRisk/england20242025.png", width = 2400, height = 2400, dpi = 300)
...
map_manchester
tmap_save(map_manchester, filename = "/Users/maggiebickerstaffe/Desktop/Dissertation/WalkableCharities/BayesianRisks/RelativeRisk/manchester20242025.png", width = 2400, height = 2400, dpi = 300)

map_london
tmap_save(map_london, filename = "/Users/maggiebickerstaffe/Desktop/Dissertation/WalkableCharities/BayesianRisks/RelativeRisk/london20242025.png", width = 2400, height = 2400, dpi = 300)
...
map_B
tmap_save(map_B, filename = "/Users/maggiebickerstaffe/Desktop/Dissertation/WalkableCharities/BayesianRisks/Significance/england20242025.png", width = 2400, height = 2400, dpi = 300)
...
map_B_manchester
tmap_save(map_B_manchester, filename = "/Users/maggiebickerstaffe/Desktop/Dissertation/WalkableCharities/BayesianRisks/Significance/manchester20242025.png", width = 2400, height = 2400, dpi = 300)
map_B_london
tmap_save(map_B_london, filename = "/Users/maggiebickerstaffe/Desktop/Dissertation/WalkableCharities/BayesianRisks/Significance/london20242025.png", width = 2400, height = 2400, dpi = 300)
...
map_C
tmap_save(map_C, filename = "/Users/maggiebickerstaffe/Desktop/Dissertation/WalkableCharities/BayesianRisks/ExceedanceProbability/england20242025.png", width = 2400, height = 2400, dpi = 300)
...
map_C_manchester
tmap_save(map_C_manchester, filename = "/Users/maggiebickerstaffe/Desktop/Dissertation/WalkableCharities/BayesianRisks/ExceedanceProbability/manchester20242025.png", width = 2400, height = 2400, dpi = 300)
map_C_london
tmap_save(map_C_london, filename = "/Users/maggiebickerstaffe/Desktop/Dissertation/WalkableCharities/BayesianRisks/ExceedanceProbability/london20242025.png", width = 2400, height = 2400, dpi = 300)
...
# write to csv
write.csv(export_df, "relative_risk_results_20242025.csv", row.names = FALSE)

################################# SAVE RDS #######################################
saveRDS(results_cross_sectional, "results_cross_sectional_2024_2025.rds")
...
fixed_only <- inla(Grade5Underperformance ~ YPAccessibilityDecile + FSMRate + PercentFemale +
                     SAMHI + LargeFringeMetro + MediumMetro + SmallMetro + Micropolitan + Noncore,
                   family = "poisson", E = cross_sectional_20242025$Expected, data = cross_sectional_20242025,
                   control.compute = list(dic = TRUE, waic = TRUE))

fitted_fixed <- fixed_only$summary.fitted.values[, "mean"] * cross_sectional_20242025$Expected
cor(cross_sectional_20242025$Grade5Underperformance, fitted_fixed)^2
